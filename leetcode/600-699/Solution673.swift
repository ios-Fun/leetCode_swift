...
class Solution673 {
    ...
    func findNumberOfLIS(_ nums: [Int]) -> Int {
        self.nums = nums
        // checkFlag = Array.init(repeating: false, count: nums.count)
        dic = [:]
...
//        }
        ...
        func dsf(_ index: Int, _ lastNum: Int?, _ count: Int) {
            if index >= nums.count{
                if count > 0 {
                    if dic[count] == nil {
                        dic[count] = 1
            ...
            // 选择 index
            if count == 0 {
                dsf(index + 1, nums[index], 1)
            } else {
                if nums[index] > lastNum! {
                    dsf(index + 1, nums[index], count + 1)
                } else {
//                    if dic[count] == nil {
//                        dic[count] = 1
//                    } else {
